<?php
/*
Это отрывок кода, из метода, печатающего сертификат. Метод принимает объекты $student, $cert(ificate). Дополнительные данные о студентах хранятся в json файлах в защищенной папке.
*/
